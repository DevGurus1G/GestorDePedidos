...
<div class="col-12 mt-4">
    <div class="row w-100 mx-auto" style="max-width: 550px">
        <div class="col">
            ...
            <h1 class="mt-2">Ver detalles de categoría | {{$categoria->nombre}}</h1>
            <form action="{{route("categorias.update", $categoria)}}" method="post" class="row mt-2">
                ...
                <div class="col-12 form-floating mb-3">
                    <div class="form-floating ">
                        <input type="text" class="form-control" disabled  id="nombre" name="nombre" placeholder="nombre" value="{{$categoria->nombre}}">
